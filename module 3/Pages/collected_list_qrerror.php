			...
			<table>
				  ...
				  <?php
					while($row=mysqli_fetch_assoc($search_result))
					{
						...
						$tempDir = "pdfqrcodes/"; //file yg store gambar qr code
						$codeContents = $qrvalue; 
						$fileName = $qrvalue . '.png'; //nama file yg store gambar qr code
						...
						$qr_code_image = "<img src='pdfqrcodes/" .$row["stud_ID"]. ".png' width='64px'>";
				  ?>
					<tr id="list">
