...
<div class="container">
  <div class="row">
    <div class="column-77">
	  ...
	  <input type="button" value="General Report" onclick="location.href='general_report.php'">
	  <input type="button" value="Report on Timely Basis" onclick="location.href='report_timely_basis.php'">
	  <input type="button" value="Percentage of Goods" onclick="location.href='goods_percentage.php'">
    </div>
