<?php
	...
	$query = "SELECT goods_collect_date, COUNT(stud_ID)
				FROM collectedlist
				GROUP BY goods_collect_date";
...
<div class="container">
  <div class="row">
    <div class="column">
		<center>
		<h1 class="xlarge-font" style="color:black"><b>Daily Report</b></h1>
		...
		<div style="float:right;" class="dropdown">
		  ...
		  <div id="myDropdown" class="dropdown-content">
			...
			<table>
			  ...
			  <?php
				$daily_query = "SELECT goods_collect_date FROM collectedlist";
				$daily_conn = mysqli_query($conn, $daily_query);
				$daily = mysqli_num_rows($daily_conn);
			  ...
			  ?>
				<tr id="list">
					...
					<td style="background-color:#b37700;font-weight:bold;color:white"><?php echo $daily ?></td>
				</tr>
