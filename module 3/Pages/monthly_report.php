<?php
	...
	$query = "SELECT MONTH(goods_collect_date), COUNT(stud_ID)
				FROM collectedlist
				GROUP BY MONTH(goods_collect_date)";
...
<div class="container">
  <div class="row">
    <div class="column">
		<center>
		<h1 class="xlarge-font" style="color:black"><b>Monthly Report</b></h1>
		...
		<div style="float:right;" class="dropdown">
		  ...
		  <div id="myDropdown" class="dropdown-content">
			...
			<table>
			  ...
			  <?php
				$monthly_query = "SELECT MONTH(goods_collect_date) FROM collectedlist";
				$monthly_conn = mysqli_query($conn, $monthly_query);
				$monthly = mysqli_num_rows($monthly_conn);
				
				while($row=mysqli_fetch_assoc($result))
				{
					$goods_collect_date = $row['MONTH(goods_collect_date)'];
