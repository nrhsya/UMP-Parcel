...
<div class="container">
	<center>
		...
		<?php
			$id = $_GET['id'];
			$sql = $conn->query("SELECT * FROM officer WHERE officer_ID = '$id' ");
			while($row= $sql->fetch_assoc()):
		?>
		<div class="table">
			<form action="action_officer.php?id=<?php echo $id; ?>"  method="post">
				<input type="text" name="user_ID" value="<?php echo ($row['officer_ID']) ?>" placeholder="ID.." readonly>
				<input type="text" name="user_name" value="<?php echo ($row['officer_name']) ?>" placeholder="Full Name..">
