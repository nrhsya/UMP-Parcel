...
<div class="container">
	<center>
		...
		<?php
			$id = $_GET['id'];
			$sql = $conn->query("SELECT * FROM warden WHERE warden_ID = '$id' ");
			while($row= $sql->fetch_assoc()):
		?>
		<div class="table">
			<form action="action_warden.php?id=<?php echo $id; ?>"  method="post">
				<input type="text" name="user_ID" value="<?php echo ($row['warden_ID']) ?>" placeholder="ID.." readonly>
				<input type="text" name="user_name" value="<?php echo ($row['warden_name']) ?>" placeholder="Full Name..">
