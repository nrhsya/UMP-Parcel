<?php
  ...
  $sql="SELECT goods_status,goods_collectedDate, COUNT(goods_status) AS Total_Received_Goods 
        FROM goodslist WHERE goods_status='Collected' 
        GROUP BY goods_collectedDate";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  
                ...
                var options = {  
                      title: 'Percentage of Total Received Goods Daily',    
                      pieHole: 0.4  
                     };  
