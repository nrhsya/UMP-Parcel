<?php
  ...
  $sql="SELECT goods_collectedDate, COUNT(goods_status) AS Total_Received_Goods 
        FROM goodslist 
        WHERE goods_status='Collected' 
        GROUP BY MONTH(goods_collectedDate)";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  
                ...
                var options = {  
                      title: 'Percentage of Total Received Goods Monthly',    
                      pieHole: 0.4  
                     };  
