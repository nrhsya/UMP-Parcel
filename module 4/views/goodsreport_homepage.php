...
<html lang="en">
<head>
<title>Receipent Report Homepage</title>
<meta charset="utf-8">
...
<body>
    ...
    <div class="container" align="center">
      <div class="row">
        ...
        <button class="button" name="goods_report" onclick="location.href='./report.php'">Received Goods List Report</button>
        <button class="button" name="toal_report" onclick="location.href='./totalReceivedParcel.php'">Total Received Parcel Report</button>
