				...
				<input type="hidden" name="action" value="insert">
					<table>						
						<tr>
							...
							<td><input type="text" id="goods_ID" name="goods_ID" placeholder="goods_ID"></td>
						</tr>
						...
						<tr>
							<th>SENDER INFO</th>
							<td><input type="text" id="goods_sender_info" name="goods_sender_info" placeholder="Sender Info"></td>
						</tr>
					...
					<input id="but" type="submit" value="Submit" name="Confirm" onclick="addgoods()">
