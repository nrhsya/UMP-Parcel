...
<div class="container">
  <div class="row">
    <div class="column-66">
	  ...
	  <input type="button" value="General Report" onclick="location.href='general_report_view.php'">
	  <input type="button" value="Separate Total Goods Report" onclick="location.href='separate_Report.php'">
    </div>
