...
<html lang="en">
<head>
<title>Mail Officer Homepage</title>
<meta charset="UTF-8">
...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="./Pages/goods_list.php">View Goods List</a>
      <a href="./Pages/active_list.php">View Active List</a>
	  <a href="./Pages/complaint_list.php">View Complaint List</a>
	  <a href="./Pages/active_list_report.php">View Active List Report</a>
    </div>
  </div> 
...
<div class="container">
  <div class="row">
    <div class="column-77">
	  ...
	  <input type="button" value="Goods List" onclick="location.href='./Pages/goods_list.php'">
	  <input type="button" value="Active List" onclick="location.href='./Pages/active_list.php'">	
	  <input type="button" value="Complaint List" onclick="location.href='../module 5/complainthomepagephp.php'">
	  <input type="button" value="Active List Report" onclick="location.href='./Pages/active_list_report.php'">
    </div>
